        ...
        <div className="p-8 bg-transparent shadow-none rounded-[2.5rem]">
          ...
          <div className="flex justify-center">
            <Button
              ...
              variant="outline"
              className={`w-full max-w-[200px] h-10 rounded-xl border-2 border-white/20 bg-white/5 backdrop-blur-md font-bold hover:bg-white/10 transition-all text-white text-xs ${isRegister ? "-mt-[20px]" : "-mt-[80px]"}`}
            >
