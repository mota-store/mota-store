        ...
        <Card className="p-8 bg-card border-border/50 shadow-2xl rounded-[2.5rem]">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase font-black tracking-widest">
              <span className="px-4 bg-transparent text-muted-foreground text-[15px]">ou continue com</span>
            </div>
          </div>
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-14 rounded-xl border-border/50 bg-background/50 backdrop-blur-sm font-bold hover:bg-accent/10 transition-all"
          >
            <svg className="w-[25px] h-[25px] mr-3" viewBox="0 0 24 24">
          ...
          <div className="mt-8 text-center">
            ...
            >
              <span className="text-[30px]">{isRegister ? "Já tenho uma conta" : "Criar nova conta"}</span>
            </button>
          </div>
        </Card>
      </motion.div>
