      ...
      >
        ...
        <Card className="p-8 bg-card border-border/50 shadow-2xl rounded-[2.5rem]">
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-14 rounded-xl border-2 border-white bg-transparent backdrop-blur-sm font-bold hover:bg-white/10 transition-all -mt-[45px] text-foreground"
          >
          ...
          <div className="mt-8 text-center">
            ...
            >
              <span className={`${isRegister ? "-mt-[355px]" : "-mt-[115px]"} inline-block`}>{isRegister ? "Já tenho uma conta" : "Criar nova conta"}</span>
            </button>
          </div>
        </Card>
      </motion.div>
