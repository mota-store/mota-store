...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-accent selection:text-accent-foreground overflow-x-hidden">
      ...
      <section className="relative w-full aspect-[19/6] min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-20 px-4 -mt-72 sm:-mt-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/20 border border-accent/30 text-accent text-sm font-black mt-0 mb-8 backdrop-blur-md">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-transparent hover:bg-white/10 border-2 border-accent text-white px-12 py-8 text-xl font-black rounded-[2rem] shadow-2xl shadow-accent/20 transition-all hover:scale-105 active:scale-95 -translate-y-2"
                  onClick={() => {
                    window.location.href = "/login";
                  }}
                >
      ...
      {!isAuthenticated && (
        <div className="container px-4 relative z-30 -mt-[334px] sm:-mt-[110px]">
